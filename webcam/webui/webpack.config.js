    ...
    return {
        ...
        plugins: [
            new webpack.DllReferencePlugin({
                ...
                manifest: path.resolve(__dirname, '/Users/gmarabout/work/gmarabout/taipy-demo-webcam-capture/venv/lib/python3.10/site-packages/taipy/gui/webapp/taipy-gui-deps-manifest.json'),
